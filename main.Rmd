...
release_all <- read.csv("Dataset1Percent/release_all.csv")
...
links_all <- read.csv("Dataset1Percent/links_all.csv")
...
page_rank <- read.csv("Dataset1Percent/pagerank_all.csv")
...
louvain <- read.csv("Dataset1Percent/louvain_all.csv")
...
betweenness_centrality <- read.csv("Dataset1Percent/betweenness_centrality_all.csv")
...
harmonic_centrality <- read.csv("Dataset1Percent/harmonic_centrality_all.csv") 
...
label_propagation <- read.csv("Dataset1Percent/label_propagation.csv")
...
union_find <- read.csv("Dataset1Percent/union_find.csv")
...
direct_usages <- read.csv("Dataset1Percent/direct_usages.csv")
...
direct_dependencies <- read.csv("Dataset1Percent/direct_dependencies.csv")
...
trans_usages <- read.csv("Dataset1Percent/trans_usages.csv")
